...
namespace JobReportingApi.Controllers
{
    ...
    public class CompanyController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateCompany(int id, [FromBody] Companies updatedCompany)
        {
            ...
            company.Creating = updatedCompany.Creating;
            company.Facts = updatedCompany.Facts;
            company.Offering = updatedCompany.Offering;
            company.CompanyOffer = updatedCompany.CompanyOffer;
            company.Motivation = updatedCompany.Motivation;
